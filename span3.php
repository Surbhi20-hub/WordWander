...
<script>
    const questions = [
        {
            type: "image",
            data: "milk.jpeg", // Image URL
            question: "What is shown in this image?",
            options: ["Leche", "Agua", "Cuenta"],
            answer: 0,
        },
        {
            type: "audio",
            data: "hello-spanish.mp3", // Audio URL
            question: "What does this sound represent?",
            options: ["Good", "Hello", "Please"],
            answer: 1,
        },
        {
            type: "video",
            data: "spanish1.mp4", // Video URL
            question: "What is pronounce in video?",
            options: ["Buenas", "días", "Hola "],
            answer: 2,
        },
        {
            type: "image",
    ...
    function loadQuestion() {
        ...
        if (usedQuestions.length >= 5) {
            ...
            setTimeout(() => {
                window.location.href = "last.php"; // Redirect after 3 seconds to last.php

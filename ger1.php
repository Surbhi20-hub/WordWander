...
<body>
    ...
    <script>
        const vocabulary = [
            { word: "Coffee", meaning: "Kaffee" },
            { word: "Tea", meaning: "Tee" },    
            { word: "Water", meaning: "Wasser" },
            { word: "Juice", meaning: "Saft" },
            { word: "Milk", meaning: "Milch" },
            { word: "Sandwich", meaning: "Sandwich" },
            { word: "Cake", meaning: "Kuchen" },
            { word: "Ice Cream", meaning: "Eis" },
            { word: "Menu", meaning: "Speisekarte" },
            { word: "Bill", meaning: "Rechnung" },
            { word: "Please", meaning: "Bitte" },
            { word: "Thank you", meaning: "Danke"},
            { word: "Cat", meaning: "Katze" },
            { word: "Dog", meaning: "Hund" },
            { word: "School", meaning: "Schule" },
            { word: "Book", meaning: "Buch" },
            { word: "To eat", meaning: "Essen" },
            { word: "To drink", meaning: "Trinken" },
            { word: "To go", meaning: "Gehen" },
            { word: "Big", meaning: "Groß" },
            { word: "Small", meaning: "Klein" },
            { word: "Teacher", meaning: "Lehrer" }
        ];

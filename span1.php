...
<body>
    ...
    <script>
        const vocabulary = [
            ...
            { word: "Sandwich", meaning: "Sándwich" },
            { word: "Cake", meaning: "Pastel" },
            { word: "Ice Cream", meaning: "Helado" },
            { word: "Menu", meaning: "Menú" },
            { word: "Bill", meaning: "Cuenta" },
            { word: "Please", meaning: "Por favor" },
            { word: "Thank you", meaning: "Gracias" },
            { word: "Cat", meaning: "Gato" },
            { word: "Dog", meaning: "Perro" },
            { word: "School", meaning: "Escuela" },
            { word: "Book", meaning: "Libro" },
            { word: "To eat", meaning: "Comer" },
            { word: "To drink", meaning: "Beber" },
            { word: "To go", meaning: "Ir" },
            { word: "Big", meaning: "Grande" },
            { word: "Small", meaning: "Pequeño" },
            { word: "Teacher", meaning: "Profesor" },
        ];
        ...
        function endQuiz() {
            console.log("Quiz ended, preparing for redirect...");
            questionElement.textContent = 'Quiz Over!';
            optionsElement.innerHTML = '';
            feedbackElement.textContent = `You scored ${score} out of ${maxQuestions}.`;
            progressBar.style.width = '100%';

            // Automatically redirect to the next session after a slight delay
            setTimeout(() => {
                console.log("Redirecting to span2.php...");
                window.location.href = 'session.php'; // Redirect to span2.php after quiz completion

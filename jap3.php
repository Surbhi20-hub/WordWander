...
<div class="quiz-container">
    ...
    <div class="completion-message" id="completionMessage" style="display:none;">Quiz completed! Redirecting...</div>
</div>
...
<script>
    const questions = [
        ...
        {
            type: "audio",
            data: "hello-japanese.mp3", // Audio URL
            question: "What does this sound represent?",
            options: ["やあ ", "こんにちは", "もしもし "],
            answer: 1,
        },
        {
            type: "video",
            data: "j1.mp4", // Video URL
            question: "What is said in this video?",
            options: ["お疲れ様です", "こんばんは ", "おはようございます"],
            answer: 2,
        },
        {
            type: "image",
    ...
    function loadQuestion() {
        ...
        if (usedQuestions.length >= questions.length) {
            ...
            setTimeout(() => {
                window.location.href = "last.php"; // Redirect after 15 seconds to last.php

...
<body>
  ...
  <script>
    ...
    // List of video URLs
    const videoList = [
      "spanish.mp4", // Replace with your video file paths
      "spanish2.mp4",
      "spanish3.mp4",
      "spanish4.mp4",
      "spanish5.mp4",
    ...
    videoPlayer.addEventListener("ended", () => {
      if (currentVideoIndex < videoList.length - 1) {
        ...
        // Automatically redirect to span3 when finished
        setTimeout(() => {
          window.location.href = 'span3.php'; // Redirect to span3.php after video finishes
    ...
    nextBtn.addEventListener("click", () => {
      ...
      if (currentVideoIndex < videoList.length) {
        ...
        // Automatically redirect to span3 when finished
        setTimeout(() => {
          window.location.href = 'session.php'; // Redirect to span3.php after video finishes
        }, 2000); // 2 seconds delay before redirection
      }
    });

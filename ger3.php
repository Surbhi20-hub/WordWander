...
<script>
    const questions = [
        {
            type: "image",
            data: "book.jpeg", // Image URL
            question: "What is shown in this image?",
            options: ["Buch", "Kuchen", "Gehen"],
            answer: 0,
        },
        {
            type: "audio",
            data: "hello-german.mp3", // Audio URL
            question: "What does this sound represent?",
            options: ["Heno", "Hallo", "Hallno"],
            answer: 1,
        },
        {
            type: "video",
            data: "g5.mp4", // Video URL
            question: "What is pronounce in this video?",
            options: ["Gute soir", "Gute matin", "Gute Nacht"],
            answer: 2,
        },
        {
            type: "image",
    ...
    function loadQuestion() {
        ...
        if (usedQuestions.length >= 4) {
            ...
            // Redirect to last.php after a delay
            setTimeout(() => {
